...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="view/blog/blogMain.jsp">Travelers</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link" href="/blog/blogMain/">Home</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="about.html">Login</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="/blog/write/">Write</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<header class="masthead"
		style="background-image: url('/resources/Lighthouse.jpg')">
			...
			<div class="row">
				<div class="col-lg-8 col-md-10 mx-auto">
					<div class="site-heading">
						<h1>Travelers</h1>
						<span class="subheading">A Blog For Traveler</span>
					</div>
				</div>
			</div>
		</div>
