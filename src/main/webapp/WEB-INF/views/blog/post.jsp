...
<body>
	...
	<header class="masthead"
		style="background-image: url('/resources/blog/img/post-bg.jpg')">
				...
				<div class="col-lg-8 col-md-10 mx-auto">
					<ul class="list-inline text-left">
						<li class="list-inline-item">
							<span class="fa-stack fa-lg" id="iconlike">
	                    		<i class="fa fa-circle fa-stack-2x"></i>
	                    		<i class="fa fa-heart fa-stack-1x fa-inverse"></i>
                    		</span>
							<span class="fa-stack fa-lg" id="iconReply">
	                    		<i class="fa fa-circle fa-stack-2x"></i>
					...
					<ul class="list-inline text-right">
						<li class="list-inline-item">
							...
							<span class="fa-stack fa-lg" id="iconList">
	                    		<i class="fa fa-circle fa-stack-2x"></i>
	                    		<i class="fa fa-list fa-stack-1x fa-inverse"></i>
                    		</span>
                    		</a>
							<span class="fa-stack fa-lg" id="iconDelete">
	                    		<i class="fa fa-circle fa-stack-2x"></i>
	                    		<i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>
                    		</span>
							<span class="fa-stack fa-lg" id="btnlike">
	                    		<i class="fa fa-circle fa-stack-2x"></i>
